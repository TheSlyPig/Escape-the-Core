...
class Ui {
  ...
  drawDifficulty() {
    ...
    if (window.difficultyLevel === 1) {
      this.toolsCtx.strokeStyle = localStorage.getItem('stage1Victory') == 'true' ? 'green' : 'blue';
      ...
      this.toolsCtx.strokeStyle = localStorage.getItem('stage2Victory') == 'true' ? 'green' : 'blue';
      ...
      this.toolsCtx.strokeStyle = localStorage.getItem('stage3Victory') ? 'green' : 'blue';
  ...
  sendHighScores() {
    ...
    if (parseInt(this.score) > 35 && window.difficultyLevel == 2) {
      db.ref('scores').push(newScore);
    }
    if (parseInt(this.score) > 19 && window.difficultyLevel == 3) {
      db.ref('scores').push(newScore);
    }
