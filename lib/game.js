...
class Game {
  constructor(
    ...
    this.center = new Center(ctx, gameCanvas, this.difficultyModifier);
    ...
    if (this.specialLineFrequency() === 1) {
      switch (Math.floor(Math.random() * this.specialLineQuantity) + 1) {
        ...
        case 6:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 9, this.color, this.lineSpeed1, this.lineSpeed2, this),
          ];
          break;
        case 7:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 10, this.color, this.lineSpeed1, this.lineSpeed2, this),
          ];
          break;
        case 8:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 11, this.color, this.lineSpeed1, this.lineSpeed2, this),
          ];
          break;
        case 9:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 12, this.color, this.lineSpeed1, this.lineSpeed2, this),
          ];
          break;
        case 10:
          this.specialFlag = true;
