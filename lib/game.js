...
class Game {
  ...
  colorChangeBackground() {
    ...
    if(this.backgroundR > 180) this.bgrUP = false;
    ...
    if(this.backgroundG > 180) this.bggUP = false;
    ...
    if(this.backgroundB > 180) this.bgbUP = false;
    ...
    if(this.backgroundR2 > 180) this.bgr2UP = false;
    ...
    if(this.backgroundG2 > 180) this.bgg2UP = false;
    ...
    if(this.backgroundB2 > 180) this.bgb2UP = false;
  ...
  choosePattern(ctx) {
    let currRgb = `rgb(${this.backgroundR + 80}, ${this.backgroundG + 80}, ${this.backgroundB + 80})`;
    let specialLines;
    if (this.specialLineFrequency() === 1) { // They rolled a special shape
      switch (Math.floor(Math.random() * this.specialLineQuantity) + 1) {
        case 1:
          ...
          specialLines = [
            new Line(ctx, this.gameCanvas, 1, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 3, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 8, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
          ];
          break;
        case 2:
          this.specialFlag = true;
        ...
        case 3:
          ...
          specialLines = [
            new Line(ctx, this.gameCanvas, 1, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 2, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 6, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 7, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
          ];
          break;
        case 4:
          this.specialFlag = true;
          specialLines = [
            ...
            new Line(ctx, this.gameCanvas, 2, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 3, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 5, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 6, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
            new Line(ctx, this.gameCanvas, 7, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
          ];
          break;
        ...
        case 6: // Cases 6 and on are rainbow lines
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 9, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth, this),
          ];
          break;
        case 7:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 10, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth, this),
          ];
          break;
        case 8:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 11, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth, this),
          ];
          break;
        case 9:
          this.specialFlag = true;
          specialLines = [
            new Line(ctx, this.gameCanvas, 12, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth, this),
          ];
          break;
        case 10:
          this.specialFlag = true;
    ...
    let allDiagLines = [
                ...
                new Line(ctx, this.gameCanvas, 2, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
                new Line(ctx, this.gameCanvas, 3, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
                new Line(ctx, this.gameCanvas, 4, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
                ];
    let allLines = [
                new Line(ctx, this.gameCanvas, 5, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
                new Line(ctx, this.gameCanvas, 6, currRgb, this.lineSpeed1, this.lineSpeed2, this.lineWidth),
  ...
  doEvilThingsToThirdStage() {
    ...
    if (parseInt(this.ui.score) > 10 && window.difficultyLevel === 3) {
      ...
      if (parseInt(this.ui.score) > 50 && parseInt(this.ui.score.charAt(3)) % 2 === 0) {
        ...
        this.backgroundR2 = 255;
        this.backgroundG2 = 255;
        this.backgroundB2 = 255;
      }
    }
  }
