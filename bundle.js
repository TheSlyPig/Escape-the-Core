...
class Game {
  ...
  render(ctx) {
    if (this.i > 75) {
      // this.lines = [new Line(ctx, this.gameCanvas, 3)];
      this.lines = [new __WEBPACK_IMPORTED_MODULE_0__line_js__["a" /* default */](ctx, this.gameCanvas, Math.floor((Math.random() * 4) + 1))];
      this.i = 0;
    } else {
      this.i += 1;
    }
